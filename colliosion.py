...
pygame.init()
background_image = pygame.transform.scale(pygame.image.load("the cars.png"), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
player = Sprite(pygame.Color("black"), 20, 20)
sprite1 = Sprite(pygame.Color("green"), 20, 20)
...
sprite2 = Sprite(pygame.Color("red"), 20, 20)
